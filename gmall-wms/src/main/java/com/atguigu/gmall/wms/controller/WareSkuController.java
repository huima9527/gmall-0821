...
public class WareSkuController {
    ...
    public ResponseVo<List<WareSkuEntity>> queryWareSkusById(@PathVariable("skuId")Long skuId){
        List<WareSkuEntity> wareSkuEntities = this.wareSkuService.queryWareSkusById(skuId);
