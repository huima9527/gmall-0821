...
public class IndexService {
    ...
    public List<CategoryEntity> queryLv1Categories() {
        ResponseVo<List<CategoryEntity>> categoriesByPid = this.pmsClient.queryCategoriesByPid(0l);
        return categoriesByPid.getData();
    }
    ...
    public void testRead() {
        ...
        System.out.println("这是读业务");
    }

    public void testWrite() {
        RReadWriteLock rwLock = this.redissonClient.getReadWriteLock("rwLock");
        rwLock.writeLock().lock(10,TimeUnit.SECONDS);
        System.out.println("这是写业务");
    }
